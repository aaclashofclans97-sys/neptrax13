...
">
                    ...
                    <div className="relative z-10">
                      <div className="font-['Google Sans Flex'] text-4xl font-extrabold bg-gradient-to-r from-[#3b82f6] via-[#6366f1] to-[#8b5cf6] bg-clip-text text-transparent mb-2">
                        98%
                      </div>
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    <ScrollReveal direction="up" delay={0}>
      <div className="flex lg:flex-col gap-4">
        ...
        <div>
          <h3 className="text-[#f1f5f9] font-semibold block text-xl">Project Breakdown:</h3>
